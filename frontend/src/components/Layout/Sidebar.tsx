...
import { BarChart3, Users, ShoppingCart, CheckSquare, MessageCircle, Mail, Settings, LogOut, Bot, MessageSquare, Sliders, Smartphone, Leaf, UserCog, Store, Package, BadgeCheck, Tags, Map, Receipt, TrendingUp, Wrench } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/blog', icon: MessageSquare, label: '오너' },
  ...
  return (
    <aside className="w-60 bg-gray-900 text-white flex flex-col">
      <div className="p-4 border-b border-gray-700">
        <NavLink to="/overview" className="block hover:opacity-80">
