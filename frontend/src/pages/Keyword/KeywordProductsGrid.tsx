...
import type { KeywordProductItem } from '../../api/keyword';
...
export default function KeywordProductsGrid({ dark, items, onSelect }: Props) {
...
function MarketBadges({ p, dark }: { p: KeywordProductItem; dark: boolean }) {
  return (
