...
from .views import (
    ...
    St11ProductDailyCrawlView, ElevenLossDeleteView, ElevenLossMarkDeletedView, St11ProductStatusRefreshView,
    ElevenSuspendSoldoutView,
    ...
    St11AdStrategyAccountsView, St11AdStrategyRunsView, St11AdStrategyScheduleView, St11AdStrategyStopView,
...
urlpatterns = [
    ...
    path('mall-profit-products/', MallProfitProductsView.as_view()),
    ...
    path('eleven-loss-products/refresh-status/', St11ProductStatusRefreshView.as_view()),
    path('eleven-my/suspend-soldout/', ElevenSuspendSoldoutView.as_view()),
    ...
    path('eleven-ad-strategy/stop/', St11AdStrategyStopView.as_view()),
    ...
    path('my-products/', MyProductsAllView.as_view()),
    ...
    path('tax/vat/crawl/', TaxVatCrawlView.as_view()),
