...
from .views import (
    ...
    GmarketSummaryView, ElevenSummaryView, ProfitDashboardView, OverviewView, OverviewExpenseView, AllMallProfitView, OverviewDailyView, ElevenAdKilllistView,
    ...
    St11CostCrawlView, St11CrawlStopView, St11CrawlStatusView, GmarketCrawlStopView, ElevenRoasView, ElevenProductRoasView, ElevenKeywordRoasView,
    St11ProductDailyCrawlView, ElevenLossDeleteView, ElevenLossMarkDeletedView, St11ProductStatusRefreshView,
    ElevenSuspendSoldoutView, ElevenSuspendSelectedView, GmarketSuspendSelectedView, ElevenSuspendAllNoMatchView,
    ...
    GmarketMyProductListView, GmarketMyAccountsView, GmarketDashboardView, GmarketCrawlStatusView, GmarketRecrawlView, GmarketRecrawlStopView, GmarketCostDetailView, GmarketManualCostView,
    GmarketPriceMatchPreviewView, GmarketPriceMatchApplyView,
    GmarketPriceCapPreviewView, GmarketPriceCapApplyView,
    MyProductsAllView,
    MyProductsStatusSummaryView,
    GmarketAdDailyView, GmarketAdGroupView,
    ElevenMyProductDetailView, ElevenMyProductAccountSummaryView, ElevenPrecheckDiffView,
    ElevenMyProductDuplicateView, ElevenIntegratedSyncView,
    ElevenPriceMatchPreviewView, ElevenPriceMatchApplyView,
    ElevenPriceCapPreviewView, ElevenPriceCapApplyView,
    ...
    ElevenAuthStatusView, ElevenVerifyOtpView, ElevenPointExpiringView,
)
...
urlpatterns = [
    ...
    path('overview/daily/', OverviewDailyView.as_view()),
    ...
    path('crawler/gmarket-cost/stop/', GmarketCrawlStopView.as_view()),
    ...
    path('eleven-my/suspend-selected/', ElevenSuspendSelectedView.as_view()),
    path('eleven-my/suspend-all-no-match/', ElevenSuspendAllNoMatchView.as_view()),
    path('eleven-my/suspend-soldout-unified/', Eleven11stSoldoutUnifiedView.as_view()),
    ...
    path('gmarket-my/suspend-selected/', GmarketSuspendSelectedView.as_view()),
    path('gmarket-my/suspend-all-no-match/', GmarketSuspendAllNoMatchView.as_view()),
    path('gmarket-my/accounts/', GmarketMyAccountsView.as_view()),
    path('gmarket-my/price-match-preview/', GmarketPriceMatchPreviewView.as_view()),
    path('gmarket-my/price-match-apply/', GmarketPriceMatchApplyView.as_view()),
    path('gmarket-my/price-cap-preview/', GmarketPriceCapPreviewView.as_view()),
    path('gmarket-my/price-cap-apply/', GmarketPriceCapApplyView.as_view()),
    ...
    path('gmarket/recrawl-stop/', GmarketRecrawlStopView.as_view()),
    path('gmarket/cost-detail/', GmarketCostDetailView.as_view()),
    path('gmarket/manual-cost/', GmarketManualCostView.as_view()),
    ...
    path('my-products/status-summary/', MyProductsStatusSummaryView.as_view()),
    path('my-products/w-codes/', WCodeDownloadView.as_view()),
    path('my-products/l-codes/start/', LCodeCheckStartView.as_view()),
    path('my-products/l-codes/stop/', LCodeCheckStopView.as_view()),
    path('my-products/l-codes/status/', LCodeStatusView.as_view()),
    ...
    path('eleven-my/precheck-diff/', ElevenPrecheckDiffView.as_view()),
    path('eleven-my/price-match-preview/', ElevenPriceMatchPreviewView.as_view()),
    path('eleven-my/price-match-apply/', ElevenPriceMatchApplyView.as_view()),
    path('eleven-my/price-cap-preview/', ElevenPriceCapPreviewView.as_view()),
    path('eleven-my/price-cap-apply/', ElevenPriceCapApplyView.as_view()),
    ...
    path('eleven/point-expiring/', ElevenPointExpiringView.as_view()),
