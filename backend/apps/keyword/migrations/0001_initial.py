# Generated by Django 5.1 on 2026-05-09 05:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['sale_status'], name='keyword_pro_sale_st_988d4f_idx'), models.Index(fields=['is_synced'], name='keyword_pro_is_sync_da74e8_idx'), models.Index(fields=['uploaded_at'], name='keyword_pro_uploade_772a1e_idx')],
            },
        ),
        migrations.CreateModel(
            name='KeywordTask',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['task_type', 'status'], name='keyword_tas_task_ty_e9199d_idx')],
            },
        ),
    ]
