# Generated by Django 5.1 on 2026-05-08 09:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['sale_status'], name='ownerclan_p_sale_st_c1f730_idx'), models.Index(fields=['is_synced'], name='ownerclan_p_is_sync_a5c412_idx'), models.Index(fields=['uploaded_at'], name='ownerclan_p_uploade_fe0de4_idx')],
            },
        ),
        migrations.CreateModel(
            name='OwnerclanTask',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['task_type', 'status'], name='ownerclan_t_task_ty_1cca0b_idx')],
            },
        ),
    ]
