...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--soldout', action='store_true', help='품절(SOUT)로 변경(가역, 셀러가 다시 판매중으로 되돌릴 수 있음). --delete/--real보다 우선순위 낮음')
    ...
    def handle(self, *args, **o):
        ...
        mode = 'delete' if o.get('delete') else ('real' if o.get('real') else ('soldout' if o.get('soldout') else 'validate'))
