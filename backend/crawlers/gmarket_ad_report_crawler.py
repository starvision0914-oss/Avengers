...
def run(login_ids=None, year=None, month=None, periods=None, log_fn=None, with_keywords=False,
    ...
    # 간편광고ON(08:01)과 시작시각이 가까워 락 경합이 잦음 — 스킵하지 말고 ON이 끝날 때까지 충분히 대기(2026-08-21)
    ok, reason = guard.preflight('지마켓상품광고비', platform='gmarket', wait=True, wait_timeout=10800)
    if not ok:
