...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'Avengers'),
        'USER': os.environ.get('DB_USER', 'rejoice888'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'rejoice888'),
...
for app_conf in INSTALLED_APPS:
    if app_conf.startswith('apps.'):
        pass  # handled by AppConfig.label in each app
